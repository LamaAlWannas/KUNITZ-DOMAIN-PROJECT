...
Six-Cysteine Framework (positions 5, 14, 30, 38, 51, 55)

Essential for disulfide bond formation
Provides rigid scaffold for active site
Active-Site Loop (positions 11–16)
...
Hydrophobic Core (positions 21–23)

Tall Y-F-Y stack
Critical for protein packing and stability
Beta-Hairpin Turn (positions 35–37)
...
Higher Specificity: Training on high-resolution structural data (≤3.5 Å resolution) provides more precise feature learning
Better Edge-Case Handling: Conservative classification strategy minimizes false positives
Discovery Capability: Single false positive represents potential novel annotation (TIQ7_RHISA)
Robust Validation: 2-fold cross-validation on 574,627 sequences confirms generalization
Optimized Threshold: MCC-based optimization provides optimal balance for imbalanced data
Limitations
...
References
Razzaq, A., et al. (2019). Microbial proteases: ubiquitous enzymes with innumerable uses. Proteins and Peptide Letters, 26(11), 802–814.

Determinants of Affinity and Proteolytic Stability in Interactions of Kunitz Family Protease Inhibitors with Mesotrypsin. PMC.

Wan, H., et al. (2013). A Spider-Derived Kunitz-Type Serine Protease Inhibitor That Acts as a Plasmin Inhibitor and an Elastase Inhibitor. PLoS ONE, 8(1), e53343.

Profile Hidden Markov Models. Käll Lab / Statistical Biotechnology, KTH.

Hidden Markov Models: Theory, Algorithms, and Applications in Bioinformatics. EurekAlert! (2025).
